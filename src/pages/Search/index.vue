...
export default {
  ...
  computed: {
    // mapGetters里面的写法:传递的是数组,因为getters计算属性是没有划分模块
  ...
  methods: {
    ...
    // 删除分类名字
    removeCategoryName(){
      // 只是把带给服务器的参数置空了，还需要向服务器发送请求
      this.searchParams.categoryName = undefined
      this.searchParams.category1Id = undefined
      this.searchParams.category2Id = undefined
      this.searchParams.category3Id = undefined
      this.getData()
      //  地址栏也需要更改：进行路由跳转，自己跳自己
  ...
  watch:{
    ...
    $route(newValue,oldValue){
      ...
      // 再次发起ajax请求
      this.getData()
      // 每一次请求完毕，应该把响应的1、2、3级分类的id置空，让他接受下一次的响应1、2、3id
      this.searchParams.category1Id = undefined
      this.searchParams.category2Id = undefined
      this.searchParams.category3Id = undefined
    }
