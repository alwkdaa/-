        ...
        <transition name="sort">
          ...
          <div class="sort" v-show="show">
            ...
            <div class="all-sort-list2" @click="goSearch">
              <div class="item" v-for="(c1, index) in categoryList" :key="c1.categoryId" v-if="index < 16"
...
export default {
  ...
  methods: {
    ...
    goSearch(event) {
      ...
      // 获取到当前出发这个事件的节点【h3、a、dt、dl】，需要带有data-dategoryname这样节点【一定是a标签】
      ...
      if (categoryname) {
        ...
        // 判断：如果路由跳转的时候，带有params参数，也应传递过去
